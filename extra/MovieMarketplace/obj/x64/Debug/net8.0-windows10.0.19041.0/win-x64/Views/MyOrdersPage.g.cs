#pragma checksum "D:\iss\MovieMarketplace\Views\MyOrdersPage.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "7921FDA98FDA4FD6381F138F9948F0F7B83854389D74F6BC1013F097AD45F67E"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace MovieMarketplace.Views
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.UI.Xaml.Markup.Compiler"," 3.0.0.2602")]
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        private partial class MyOrdersPage_obj4_Bindings :
        ...
        {
            private global::MovieMarketplace.Models.TransactionView dataRoot;
            ...
            private MyOrdersPage_obj4_BindingsTracking bindingsTracking;

            public MyOrdersPage_obj4_Bindings()
            {
                this.bindingsTracking = new MyOrdersPage_obj4_BindingsTracking(this);
            }
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_(global::WinRT.CastExtensions.As<global::MovieMarketplace.Models.TransactionView>(item), 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = global::WinRT.CastExtensions.As<global::MovieMarketplace.Models.TransactionView>(newDataRoot);
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::MovieMarketplace.Models.TransactionView obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.Update_IsPendingVisibility(obj.IsPendingVisibility, phase);
                    }
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_ID(obj.ID, phase);
                        this.Update_EquipmentTitle(obj.EquipmentTitle, phase);
                        this.Update_Amount(obj.Amount, phase);
                        this.Update_ShippingAddress(obj.ShippingAddress, phase);
                        this.Update_Status(obj.Status, phase);
                    }
                }
            }
            private void Update_IsPendingVisibility(global::Microsoft.UI.Xaml.Visibility obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\MyOrdersPage.xaml line 35
            ...
            private void Update_EquipmentTitle(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Views\MyOrdersPage.xaml line 29
            ...
            private void Update_ShippingAddress(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Status(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Views\MyOrdersPage.xaml line 32
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.UI.Xaml.Markup.Compiler"," 3.0.0.2602")]
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            private class MyOrdersPage_obj4_BindingsTracking
            {
                private global::System.WeakReference<MyOrdersPage_obj4_Bindings> weakRefToBindingObj; 

                public MyOrdersPage_obj4_BindingsTracking(MyOrdersPage_obj4_Bindings obj)
                {
                    weakRefToBindingObj = new global::System.WeakReference<MyOrdersPage_obj4_Bindings>(obj);
                }

                public MyOrdersPage_obj4_Bindings TryGetBindingObject()
                {
                    MyOrdersPage_obj4_Bindings bindingObject = null;
        ...
        public void Connect(int connectionId, object target)
        {
            switch(connectionId)
            {
            case 2: // Views\MyOrdersPage.xaml line 18
                {
                    this.OrdersList = global::WinRT.CastExtensions.As<global::Microsoft.UI.Xaml.Controls.ListView>(target);
                }
                break;
            case 5: // Views\MyOrdersPage.xaml line 35
                {
                    ...
                    ((global::Microsoft.UI.Xaml.Controls.Button)element5).Click += this.ConfirmDelivery_Click;
                }
                break;
            case 10: // Views\MyOrdersPage.xaml line 14
                {
